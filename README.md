...
## Project Overview
It is an enterprise-grade Blue Team network security simulation designed and implemented using Cisco Packet Tracer.
...
- NAT
## Project Type
Enterprise Blue Team Network Security Training Project
Built for practical security training, real-world defensive scenarios, and portfolio presentation.
